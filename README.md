...
This is the Mochi chatbot project. Given below are instructions on how to use it.
...
- OpenAI Codex assisted with generating and reviewing automated tests and auditing error handling.
